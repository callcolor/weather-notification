...
abstract public class BaseWeatherNotificationReceiver extends
    ...
    protected void notify(Context context, Weather weather) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "weather-notification";
            String description = "Display weather notification";
            int importance = NotificationManager.IMPORTANCE_DEFAULT;
            NotificationChannel channel = new NotificationChannel("weather-notification", name, importance);
            channel.setDescription(description);
            NotificationManager notificationManager = getNotificationManager(context);
            notificationManager.createNotificationChannel(channel);
        }

        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "weather-notification");
